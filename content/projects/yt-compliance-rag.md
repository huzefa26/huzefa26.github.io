...
featured = true
weight = 2
main_image = "/images/project-yt-compliance.jpg"
...
- [PLACEHOLDER] Symlinks configs into place
- [PLACEHOLDER] Installs a curated tool list per OS
- [PLACEHOLDER] One command to update and pull

## Tech

[PLACEHOLDER] Plain shell script, deliberately dependency-free.