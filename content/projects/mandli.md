...
- [PLACEHOLDER] Scaffold new projects from templates
- [PLACEHOLDER] Run repeatable tasks with a single command
- [PLACEHOLDER] Plugin architecture so you can extend it

## Tech

[PLACEHOLDER] Built with Go; ships as a single static binary.